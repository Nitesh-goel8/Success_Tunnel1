...
const faqs = [
  ...
  },
  {
    ...
    answer: "No initial preparation is required. In our first call with Neeraj Aggarwal, we will clarify your goals and let you know exactly what files or documents might be needed."
  },
  {
        ...
        <section className="hero-section" style={{ paddingTop: '80px', paddingBottom: '40px' }}>
          <div className="container" style={{ textAlign: 'center', maxWidth: '800px' }}>
            ...
            <p style={{ fontSize: '1.2rem', color: 'var(--muted)', lineHeight: '1.65' }}>
              Reach out to Neeraj Aggarwal &amp; our advisory team — we&apos;ll guide you to the right service path with clear next steps.
            </p>
          </div>
        </section>
            ...
            <div className="contact-info-panel">
              ...
              <div className="contact-detail-item">
                ...
                <div className="contact-detail-text">
                  ...
                  <p>
                    ...
                    <a href="tel:+917206189559" style={{ color: 'var(--muted)', fontSize: '0.92rem', display: 'block' }}>+91 72061 89559</a>
                    <a href="tel:+919253083810" style={{ color: 'var(--muted)', fontSize: '0.92rem', display: 'block' }}>+91 92530 83810</a>
                  </p>
                </div>
              </div>
              ...
              <div className="contact-detail-item">
                ...
                <div className="contact-detail-text">
                  <h4>Email Us</h4>
                  <p>
                    <a href="mailto:successtunnel.in@gmail.com" style={{ color: 'var(--primary)', fontWeight: 700 }}>
                      successtunnel.in@gmail.com
                    </a>
                  </p>
                </div>
              </div>
              ...
              <div className="contact-detail-item">
                ...
                <div className="contact-detail-text">
                  <h4>WhatsApp</h4>
                  <p>
                    <a href="https://wa.me/918950771205" target="_blank" rel="noreferrer" style={{ color: 'var(--accent)', fontWeight: 700 }}>
              ...
              <div className="contact-detail-item">
                ...
                <div className="contact-detail-text">
                  ...
                  <p>
                    ...
                    <span style={{ fontSize: '0.88rem', color: 'var(--muted)' }}>Closed on Sundays &amp; Public Holidays</span>
                  </p>
                </div>
              </div>
              ...
              <div className="contact-detail-item">
                ...
                <div className="contact-detail-text">
                  ...
                  <p>
                    <strong>Neeraj Aggarwal</strong><br />
                    <span style={{ fontSize: '0.88rem', color: 'var(--muted)' }}>Chartered Accountant &amp; Principal Advisor</span>
                  </p>
                </div>
              </div>
            </div>
        ...
        <section style={{ padding: '0 0 96px 0', overflow: 'hidden' }}>
          <div className="container" style={{ overflow: 'hidden' }}>
            <div style={{ borderRadius: '24px', overflow: 'hidden', height: '420px', border: '1px solid var(--line)', boxShadow: '0 15px 45px rgba(15, 23, 42, 0.05)', position: 'relative', width: '100%' }}>
              <iframe
                src="https://www.google.com/maps?q=Sudarshan+Tower+Panipat+Haryana+132103&output=embed"
                width="100%"
                height="100%"
                ...
                title="SuccessTunnel Office — Panipat"
              />
            </div>
            <div style={{ textAlign: 'center', marginTop: '16px' }}>
              <a
                href="https://maps.app.goo.gl/n4wZ51qrRY1zSPeb8"
                target="_blank"
                rel="noreferrer"
