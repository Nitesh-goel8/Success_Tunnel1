          ...
          <div className="container article-hero">
            <div>
              ...
              <p style={{ margin: '18px 0 0', maxWidth: 700, color: 'var(--muted)', fontSize: '1.06rem' }}>
                This page can be expanded with your final privacy wording before launch.
              </p>
            </div>
            <div className="article-feature">
              <div className="service-card-kicker">Placeholder</div>
              <h2 style={{ margin: '14px 0 0', fontSize: '2rem', lineHeight: 1.04 }}>Privacy content goes here.</h2>
              <p style={{ marginTop: 14 }}>
                We created this page so the footer link remains valid while the final policy text is prepared.
              </p>
            </div>
          </div>
        </section>
